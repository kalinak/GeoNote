...
namespace GeoNote
{
    public partial class App : Application, IServiceProvider
    {
        ...
        // directions
        public RouteQuery MyQuery { get; set; }
        public GeocodeQuery Mygeocodequery { get; set; }
        ...
        public App()
        {
            ...
            /* XNA initialization (for hybrid features such as Microphone) */
        ...
        {
            var geoNoteDatabaseUtility = new GeoNoteDatabaseUtility();
            //bool wipeDatabase = Debugger.IsAttached;
            geoNoteDatabaseUtility.InitializeDatabase();
        }
        ...
        public object GetService(Type serviceType)
        {
            ...
            throw new InvalidOperationException(
                "No object in the ApplicationLifetimeObjects is assignable to "
                    + serviceType);
        }
